					...
					<div class="col-md-4">
						...
						<div class="form-group">
							...
							<form:select class="form-control" path="tipoAnais">
								<form:option value="">Selecione</form:option>
								<form:option value="ARTIGO">ARTIGO</form:option>
								<form:option value="POSTER">POSTER</form:option>
								<form:option value="RESUMO">RESUMO</form:option>
						...
						<div class="form-group">
							...
							<form:select class="form-control" path="tipoMidia">
								...
								<form:option value="DVD">DVD</form:option>
						...
						<div class="form-group">
							...
							<form:select class="form-control" path="tipoTrabalho">
								<form:option value="">Selecione</form:option>
								<form:option value="MONOGRAFIA">MONOGRAFIA</form:option>
								<form:option value="DISSERTACAO">DISSERTACAO</form:option>
								<form:option value="TESE">TESE</form:option>
