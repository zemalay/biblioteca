...
<title>Emprestimo Detalhes</title>
</head>
<body>
				...
				<div class="row" id="formulario">
					<div class="col-md-6">
						...
						<c:if test="${emprestimo.entregou == true }">
							...
							<form:label path="dataCadastrado">Data Cadastrado</form:label>
							<form:input class="form-control" path="dataCadastrado"
								placeholder="data cadastrado" readonly="true" />

							<form:label path="dataDevolucao">Data Devolucao</form:label>
							<form:input class="form-control" path="dataDevolucao"
								placeholder="data devolucao" readonly="true" />
						</c:if>
						...
						<c:if test="${emprestimo.entregou == false }">
							...
							<form:label path="dataCadastrado">Data Cadastrado</form:label>
							<form:input class="form-control" path="dataCadastrado"
								placeholder="data cadastrado" readonly="false" />

							<form:label path="dataDevolucao">Data Devolucao</form:label>
							<form:input class="form-control" path="dataDevolucao"
								placeholder="data devolucao" readonly="false" />
						</c:if>
