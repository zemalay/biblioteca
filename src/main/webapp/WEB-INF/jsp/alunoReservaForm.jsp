...
<body>
	...
	<div id="wrapper" style="background-color: darkcyan;">
		...
		<div class="modal-content">
			<h2 class="text-center">Cadastro da Reserva</h2>
			<form:form id="reserva-form" cssClass="container"
				onsubmit="return checkCampos();" modelAttribute="reserva"
				method="POST" action="/biblioteca/aluno/reserva/add">
				<div class="row" id="formulario">
					<div class="col-md-6">
						...
						<div class="form-check">
							<form:checkbox class="form-check-input" path="email" />
							<form:label class="form-check-label" path="email">notificacao via e-mail</form:label>
						</div>
